package com.mainapp.proposal.dto;

import com.mainapp.credit.enums.CreditKind;
import com.mainapp.proposal.enums.DescriptionRejected;
import com.mainapp.proposal.enums.StatusProposal;
...
public class ProposalDto implements Comparable<ProposalDto>{
    ...
    public ProposalDto(final BuilderProposalDto builder) {
        this.id = builder.id;
